# River Reviewer: Governance Layer Index

EOS 5-layer ([`docs/ai/eos-overview.md`](../docs/ai/eos-overview.md)) の **Governance** layer 索引。river-reviewer の運用ルール / ownership / approval / deprecation は既存 doc に分散しているため、本 index を起点に辿れるようにする。
...
| Memory / suppression      | repo メンテナ                                                 | [`skills/agent-skills/river-reviewer/references/`](../skills/agent-skills/river-reviewer/references/), [`pages/guides/use-riverbed-memory.md`](../pages/guides/use-riverbed-memory.md)   |
...
4. **fixture / golden / promptfoo の整備**（新規 skill の場合は [`skills/agent-skills/river-reviewer/references/IMPROVEMENT_LOOP.md`](../skills/agent-skills/river-reviewer/references/IMPROVEMENT_LOOP.md) Step 6-7）
...
- **Epic 起票**: 影響範囲と理由を Issue body に記載（例: [Epic #743](https://github.com/s977043/river-reviewer/issues/743)）
...
- **memory entry**: 再現可能な操作上の知見は `~/.claude/projects/-Users-user-Documents-GitHub-river-reviewer/memory/` の `feedback_*.md` として永続化

過去の主要 migration:

| 時期    | 変更                                                                    | 参照                                                                                        |
| ------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| 2026-04 | Epic #507 PlanGate v6 完了                                              | [Issue #507](https://github.com/s977043/river-reviewer/issues/507)                          |
| 2026-05 | Epic #743 Skill Improvement Loop (river-reviewer entry skill 再定義)    | [Issue #743](https://github.com/s977043/river-reviewer/issues/743)                          |
...
- Memory: [`skills/agent-skills/river-reviewer/references/`](../skills/agent-skills/river-reviewer/references/)
