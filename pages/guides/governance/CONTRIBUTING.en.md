...
- Write documents in Japanese (Japanese version is Source of Truth). If preparing English version, add `.en.md` with same name; prioritize Japanese version if content diverges.
- Provide English examples for technical terms if needed.
- Follow the style guide (See [WRITING_GUIDE.md](WRITING_GUIDE.md)).
