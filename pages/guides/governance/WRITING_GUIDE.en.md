...
> **Under Preparation**
> This guide is currently being written. Please wait for completion.
...
- **Language Policy**: Japanese version (`.md`) is primary. If adding an English version, create `.en.md` with the same name. Priority is given to the Japanese version if content diverges.
