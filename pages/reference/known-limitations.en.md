...
River Reviewer is currently in the stage of establishing its OSS foundation. Here are notes for usage.
...
- Since breaking changes may occur, we recommend pinning GitHub Actions to a release tag (e.g., `@v0.28.0`).
