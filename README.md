...
ローカル diff に対して試す（coming soon）:

> ⚠️ **CLI パッケージは現在 npm に公開されていません。** `npx river run . --dry-run` は [#800](https://github.com/s977043/river-review/issues/800) が完了するまで実行できません。それまでは上の GitHub Actions 経由の手順をご利用ください。
...
最新リリース: [v0.69.0](https://github.com/s977043/river-review/releases/latest)
