...
| 指摘の再現性     | 毎回ブレる               | suppression memory / fixture 回帰 / 決定論スコアリング |
...
plan / exec ゲートが、適切なタイミングで skill を実行します。PR 完成後だけでなく、設計時・実装中のいずれでも動かせます（verify ゲートは [#802](https://github.com/s977043/river-review/issues/802) で計画中）。
...
タグは `@v1.2.2` などのリリースタグにピン留めしてください。あるいは、常に最新の 1.x を指す浮動メジャーバージョンエイリアス `@v1` を使うこともできます。

<!-- x-release-please-start-version -->

最新リリース: [v1.7.0](https://github.com/s977043/river-review/releases/latest)
