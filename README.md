...
PR 上で River Review を動かす最短手順は GitHub Actions 経由です（[クイックスタート](#クイックスタートgithub-actions)）。CLI パッケージは [#800](https://github.com/s977043/river-review/issues/800) 完了まで未公開です。
