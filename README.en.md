...
Pin to a release tag such as `@v0.2.0` for stability. Optionally, you can maintain a floating alias tag like `@v0`.

Latest release: [v0.5.0](https://github.com/s977043/river-reviewer/releases/tag/v0.5.0)

> **ℹ️ Upgrading from v0.1.x:** v0.2.0 and later use the new GitHub Action path `runners/github-action` instead of `.github/actions/river-reviewer`. See [Migration Guide](docs/migration/runners-migration-guide.md) and [DEPRECATED.md](DEPRECATED.md) for details.
