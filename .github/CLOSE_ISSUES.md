...
```markdown
READMEのProjectsリンクを修正しました（`https://github.com/users/s977043/projects/2` → `https://github.com/s977043/river-review/projects`）。
...
以下のURLからPRを作成してください:
<https://github.com/s977043/river-review/pull/new/fix/lychee-links>
...
- `https://github.com/users/s977043/projects/2` (404) → `https://github.com/s977043/river-review/projects`
